...
#define IIC_SCL_GPIO_CLK_ENABLE()       do{ RCC->APB2ENR |= 1 << 4; }while(0)   /* PC口时钟使能 */

#define IIC_SDA_GPIO_PORT               GPIOC
#define IIC_SDA_GPIO_PIN                SYS_GPIO_PIN11
#define IIC_SDA_GPIO_CLK_ENABLE()       do{ RCC->APB2ENR |= 1 << 4; }while(0)   /* PC口时钟使能 */
