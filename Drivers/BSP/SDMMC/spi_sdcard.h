...
#define SD_CS_GPIO_PIN                  SYS_GPIO_PIN3
#define SD_CS_GPIO_CLK_ENABLE()         do{ RCC->APB2ENR |= 1 << 2; }while(0)   /* PA口时钟使能 */
...
/******************************************************************************************/
/* SD_CS 端口定义 */
#define SD_CS(x)    sys_gpio_pin_set(SD_CS_GPIO_PORT, SD_CS_GPIO_PIN, x)    /* SD_CS */
